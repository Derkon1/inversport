...
class ThemeManager:
    ...
    THEMES = {
        'dark': {
            # Colores base
            'bg_dark': '#bebebe',           # Fondo general gris muy claro
            'bg_sidebar': '#7f8c8d',         # Sidebar negro profundo
            'bg_main': '#bebebe',            # Fondo prin
            
            # Tarjetas
            'card_bg': '#ffffff',            # Fondo de tarjetas blanco
            'card_hover': '#e8e8ee',         # Hover gris claro
            
            # Acentos
            'accent': '#2d7d56',             # Gris oscuro (títulos, botones)
            'accent_hover': '#ffffff',       # Negro para hover
            'accent_light': '#ffffff',       # Gris medio para detalles
            
            # Estados
            'success': '#2d7d56',            # Verde suave para éxito
            'warning': '#f59e0b',            # Dorado suave para advertencia
            ...
            'text_white': '#ffffff',         # gestion de talento
            ...
            'input_bg': '#bebebe',           # Fondo de inputs blanco
            'input_border': '#000',       # Borde de inputs
            'shadow': '#9a9a9a',           # Sombra sutil
            'white': '#ffffff',
        }
    }
