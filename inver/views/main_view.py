...
class AppNomina(
    ...
    def __init__(self, root):
        # 1. PRIMERO: Inicializar BaseView para tener los métodos de validación
        BaseView.__init__(self)
        
        # 2. Luego inicializar el resto
        self.root = root
        ...
        # 3. Registrar los métodos de validación
        ...
        # 4. Inicializar nómina (esto cargará la base de datos si está disponible)
        self.nomina = Nomina()
