# inver/views/components/calendario.py
...
class CalendarioMixin:
    """Mixin que proporciona métodos para abrir el calendario popup."""
    ...
    def _cerrar_calendario(self):
        """Cierra el calendario si está abierto."""
        if hasattr(self, 'cal_popup') and self.cal_popup:
            try:
                self.cal_popup.cerrar()
            except:
    ...
    def _on_calendar_selected(self):
        ...
        # Verificar si existe el método y el widget antes de llamarlo
        ...
        # Verificar si existe el método y los widgets antes de llamarlo
